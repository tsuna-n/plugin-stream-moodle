...
/**
 * Capability definitions for mod_livestream.
 *
...
$capabilities = [
    ...
    // Whoever holds this sees the OBS stream key / RTMP details and the Zoom host start URL.
    'mod/livestream:managestream' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => [
            'teacher' => CAP_ALLOW,
