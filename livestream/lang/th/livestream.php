...
$string['settingrealtimesecret'] = 'รหัสลับที่ใช้ร่วมกันสำหรับ Realtime';
$string['settingrealtimesecret_desc'] = 'รหัสลับ HMAC ที่ใช้ร่วมกัน สำหรับเซ็นโทเคน realtime และยืนยันตัวตนการเรียกระหว่างเซิร์ฟเวอร์ (server-to-server) ระหว่าง Moodle กับ realtime gateway (ต้องตั้งค่าเดียวกันนี้เป็น REALTIME_SECRET ในสภาพแวดล้อมของ gateway ด้วย) หาก realtimeurl ยังเว้นว่างอยู่ ให้เว้นค่านี้ว่างไว้เช่นกัน';
$string['settingrealtimeurl'] = 'URL ของ Realtime Gateway';
$string['settingrealtimeurl_desc'] = 'Base URL สาธารณะของ realtime gateway (เช่น https://rt.media.example.com) ที่เข้าถึงผ่าน Caddy ใน media-server docker-compose เมื่อตั้งค่านี้ไว้ เครื่องเล่น แชทสด และป้าย "กำลังถ่ายทอดสด" ในเมนูรายวิชาจะเปลี่ยนจากการโพลไปใช้การเชื่อมต่อแบบพุชทันที (SSE) โดยจะย้อนกลับไปใช้การโพลอัตโนมัติหากเชื่อมต่อ gateway ไม่ได้ หากเว้นว่างไว้ ระบบจะใช้การโพลแบบเดิมโดยไม่ต้องมี realtime gateway';
$string['settingsrealtimeheading'] = 'Realtime (ถ่ายทอดสดแบบเต็มรูปแบบ)';
$string['settingsrealtimeheading_desc'] = 'Gateway แบบพุชทันทีที่ไม่บังคับใช้ ซึ่งแทนที่ลูปการโพลของเครื่องเล่น/แชท/ป้ายสถานะด้วยการอัปเดตทันทีผ่าน Server-Sent Events ดูโฟลเดอร์ realtime ในชุดปลั๊กอินสำหรับ Node gateway หากเว้น realtimeurl ว่างไว้ ระบบจะยังคงทำงานแบบโพลเหมือนเดิมทุกประการ';
