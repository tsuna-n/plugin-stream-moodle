...
- **`livestream_extend_navigation_course($navigation, $course, $context)`** — เพิ่มลิงก์ 2 อัน
  ...
  บัญชี Zoom ได้ตั้งแต่ก่อนสร้างกิจกรรมแรก) และ "Live streams" (ถ้ามีสิทธิ์ `view` และรายวิชานี้มี
  กิจกรรมถ่ายทอดสดอย่างน้อย 1 ตัว) พร้อมสั่งโหลด AMD module `mod_livestream/navbadge` เพื่อแปะป้าย
...
### 3.5 `index.php`
หน้ารายการกิจกรรมถ่ายทอดสดทั้งหมดในรายวิชา (`mod/livestream/index.php?id=<courseid>`) — ใช้
`get_all_instances_in_course()` มาตรฐาน แล้วแสดงตารางชื่อ/ประเภท/เวลาเริ่ม พร้อมลิงก์เข้าแต่ละ
กิจกรรม ถ้าไม่มีกิจกรรมเลยจะแสดง `notice()` พาย้อนกลับไปหน้ารายวิชา
